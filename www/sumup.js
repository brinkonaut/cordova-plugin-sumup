...
module.exports = {
    ...
    pay: function (amount, currencycode, title, identifier) {
        return new Promise((resolve, reject) => cordova.exec(resolve, reject, 'SumUp', 'pay', [amount, currencycode, title, identifier]));
    },
}
